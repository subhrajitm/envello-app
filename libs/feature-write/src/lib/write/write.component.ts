...
import { AiAssistantPanelComponent, AiPanelMessage, TableComponent, type EnvTableColumn, type EnvTableAction, ConfirmDialogComponent, FeatureSidebarComponent, EmptyStateComponent, SliderPanelComponent, ChipComponent } from '@envello/ui';
...
@Component({
  selector: 'app-write',
  standalone: true,
  imports: [CommonModule, FormsModule, AiAssistantPanelComponent, TableComponent, ConfirmDialogComponent, FeatureSidebarComponent, EmptyStateComponent, SliderPanelComponent, ChipComponent],
...
export class WriteComponent {
  ...
  readonly tableColumns: EnvTableColumn[] = [
    ...
    { key: 'type',     header: 'Type',     type: 'badge', sortable: true, badgeMap: {
      'Novel':       { variant: 'warning', icon: 'menu_book'     },
      'Short Story': { variant: 'info',    icon: 'short_text'    },
      'Article':     { variant: 'success', icon: 'article'       },
      'Essay':       { variant: 'purple',  icon: 'edit_note'     },
      'Script':      { variant: 'error',   icon: 'movie'         },
      'Poetry':      { variant: 'error',   icon: 'format_quote'  },
      'Blog Post':   { variant: 'info',    icon: 'web'           },
      'Research':    { variant: 'purple',  icon: 'science'       },
    }},
    { key: 'status',   header: 'Status',   type: 'badge', sortable: true, badgeMap: {
      'Planning':  { variant: 'default', icon: 'pending'       },
      'Drafting':  { variant: 'warning', icon: 'edit'          },
      'Revising':  { variant: 'warning', icon: 'rate_review'   },
      'Published': { variant: 'success', icon: 'check_circle'  },
    }},
