...
import { MediaComponent } from '@envello/feature-media';
import { RecipesComponent } from '@envello/feature-recipes';

type Section = 'media' | 'recipes';

@Component({
  selector: 'lib-personal-hub',
  standalone: true,
  imports: [MediaComponent, RecipesComponent],
  template: `
    <div class="hub-wrap">
      <div class="hub-bar">
