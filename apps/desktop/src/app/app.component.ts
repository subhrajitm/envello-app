...
import { HeaderComponent, FooterComponent, EnvLogoComponent, KeyboardShortcutsComponent, OnboardingComponent, WhatsNewComponent, ToastComponent, WebPreviewComponent } from '@envello/ui';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HeaderComponent, FooterComponent, EnvLogoComponent, KeyboardShortcutsComponent, OnboardingComponent, WhatsNewComponent, UpdateBannerComponent, TitlebarComponent, ToastComponent, WebPreviewComponent],
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  mapUrlToTabName(url: string): string {
    const map: Record<string, string> = {
      ...
      'people': 'People', 'habits': 'Habits', 'recipes': 'Recipes', 'lists': 'Lists', 'goals': 'Goals', 'media': 'Media', 'journal': 'Journal', 'analytics': 'Analytics',
    };
