...
let HeaderComponent = class HeaderComponent {
  ...
  activeSectionForSubNav = computed(() => {
    ...
    return (
      this.navSections.find((s) => s.items.some((i) => i.route === seg)) ?? null
    );
  });
  navSections = [
    {
...
__decorate([Input()], HeaderComponent.prototype, 'activeTab', void 0);
__decorate([Input()], HeaderComponent.prototype, 'isImmersive', void 0);
__decorate(
  [Output()],
