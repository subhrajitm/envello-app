...
let VersionHistoryService = class VersionHistoryService {
     ...
     */
    createSnapshot(contentId, contentType, content, title, wordCount = 0, description) {
        return {
     ...
     */
    addVersion(contentId, contentType, content, title, wordCount = 0, immediate = false) {
    ...
    restoreVersion(contentId, contentType, versionId) {
        ...
        if (versionIndex >= 0) {
            ...
            if (versionIndex < history.currentIndex) {
                ...
                const newSnapshot = this.createSnapshot(contentId, contentType, restoredVersion.content, restoredVersion.title, restoredVersion.wordCount, 'Restored from version history');
